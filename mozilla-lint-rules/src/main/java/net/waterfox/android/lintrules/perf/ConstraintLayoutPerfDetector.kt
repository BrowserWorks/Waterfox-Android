...
package net.waterfox.android.lintrules.perf
...
private const val WATERFOX_PREFIX = "net.waterfox.android"
...
private val CUSTOM_VIEW_ELEMENTS = setOf(
    "$WATERFOX_PREFIX.library.LibrarySiteItemView",
    "$WATERFOX_PREFIX.settings.deletebrowsingdata.DeleteBrowsingDataItem",
    "$WATERFOX_PREFIX.trackingprotection.SwitchWithDescription",
    "$WATERFOX_PREFIX.trackingprotection.TrackingProtectionCategoryItem",
