...
import net.waterfox.android.components.history.HistoryDB
...
class HistoryDataSourceTest {
    private val testCases = listOf(
        ...
        listOf(1, 2, 3) to listOf(
            TestHistory.Metadata("http://www.mozilla.com"),
            TestHistory.Regular("http://www.mozilla.com/2"),
            TestHistory.Group("waterfox", items = listOf())
        ),
        listOf(1, 2, 3) to listOf(
            TestHistory.Metadata("http://www.mozilla.com"),
            TestHistory.Regular("http://www.mozilla.com/2"),
        ...
        listOf(1, 2, 7) to listOf(
            ...
            TestHistory.Group(
                ...
                items = listOf(
                    "http://www.waterfox.net",
                    "http://www.waterfox.net/2",
                    "http://www.waterfox.net/3",
                    "http://www.waterfox.net/4",
                    "http://www.waterfox.net/5"
                )
            )
        ),
