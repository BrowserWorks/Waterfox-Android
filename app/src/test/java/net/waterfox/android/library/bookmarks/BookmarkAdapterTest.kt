...
import net.waterfox.android.library.bookmarks.viewholders.BookmarkNodeViewHolder
...
internal class BookmarkAdapterTest {
    ...
    fun `update adapter from tree of bookmark nodes, null tree returns empty list`() {
        val tree = testFolder(
            ...
            listOf(
                ...
                testSeparator("123"),
                testBookmarkItem("123", "https://www.waterfox.net/en-US/waterfox/")
            )
        )
    ...
    fun `update adapter from tree of bookmark nodes, separators are excluded`() {
        ...
        val item2 = testBookmarkItem("123", "https://www.waterfox.net/en-US/waterfox/")
    ...
    fun `update adapter from tree of bookmark nodes, folders are moved to the top`() {
        ...
        val item1 = testBookmarkItem("123", "http://mozilla.org")
        val item2 = testBookmarkItem("123", "https://www.waterfox.net/en-US/waterfox/")
        val item3 = testBookmarkItem("123", "https://www.waterfox.net/en-US/waterfox/2")
        val item4 = testBookmarkItem("125", "https://www.waterfox.net/en-US/waterfox/3")
    ...
    fun `get item view type for different types of nodes`() {
        val sep1 = testSeparator("123")
        val item1 = testBookmarkItem("123", "https://www.waterfox.net/en-US/waterfox/")
