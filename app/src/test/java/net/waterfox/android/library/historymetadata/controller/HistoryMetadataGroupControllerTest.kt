...
package net.waterfox.android.library.historymetadata.controller
...
class HistoryMetadataGroupControllerTest {
    ...
    private val waterfoxHistoryMetadataItem = History.Metadata(
        position = 1,
        title = "Waterfox",
        url = "waterfox.net",
        visitedAt = 0,
    ...
    private fun getMetadataItemsList() =
        listOf(mozillaHistoryMetadataItem, waterfoxHistoryMetadataItem)
    ...
    @Test
    fun handleShare() {
        controller.handleShare(setOf(mozillaHistoryMetadataItem, waterfoxHistoryMetadataItem))
        ...
        val data = arrayOf(
            ...
            ShareData(
                title = waterfoxHistoryMetadataItem.title,
                url = waterfoxHistoryMetadataItem.url
            ),
        )
