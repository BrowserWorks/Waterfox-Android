...
class SupportUtilsTest {
    ...
    fun getMozillaPageUrl() {
        ...
        assertEquals(
            "https://www.mozilla.org/zh/privacy/waterfox/",
    ...
    private fun mockContext(versionName: String): Context {
        ...
        every { context.packageName } returns "net.waterfox.android"
        every { context.packageManager } returns packageManager
        every { packageManager.getPackageInfo("net.waterfox.android", 0) } returns packageInfo
