...
package net.waterfox.android.collections
...
import net.waterfox.android.databinding.CollectionsListItemBinding
    ...
    fun `creates and binds viewholder`() {
        ...
        val collection = mockk<TabCollection> {
            ...
            every { tabs } returns listOf(
                ...
                mockk {
                    every { url } returns "https://waterfox.net"
                }
            )
        }
        adapter.updateData(
        ...
        assertEquals("mozilla.org, waterfox.net", binding.collectionDescription.text)
