...
class HomeDeepLinkIntentProcessorTest {
    ...
    @Test
    fun `return true if scheme is waterfox`() {
    ...
    @Test
    fun `return true if scheme is a Waterfox variant`() {
        assertTrue(processorHome.process(testIntent("waterfox-beta://test"), navController, out))
