...
class WebExtensionPromptFeatureTest {
    ...
    fun `WHEN calling handleInstallationFailedRequest with network error THEN showDialog with the correct message`() {
        val expectedTitle =
            testContext.getString(mozilla.components.feature.addons.R.string.mozac_feature_addons_cant_install_extension)
        ...
        val expectedMessage =
            testContext.getString(
                mozilla.components.feature.addons.R.string.mozac_feature_addons_extension_failed_to_install_network_error,
                "name",
            )
    ...
    fun `WHEN calling handleInstallationFailedRequest with Blocklisted error THEN showDialog with the correct message`() {
        ...
        val expectedMessage =
            testContext.getString(
                mozilla.components.feature.addons.R.string.mozac_feature_addons_blocklisted_2,
                extensionName,
                appName,
            )
        val expectedUrl =
            "${BuildConfig.AMO_BASE_URL}/android/blocked-addon/$extensionId/$extensionVersion/"
    ...
    fun `WHEN calling handleInstallationFailedRequest with UserCancelled error THEN do not showDialog`() {
        ...
        val expectedMessage =
            testContext.getString(mozilla.components.feature.addons.R.string.mozac_feature_addons_failed_to_install, extensionName)
    ...
    fun `WHEN calling handleInstallationFailedRequest with Unknown error and no extension name THEN showDialog with the correct message`() {
        ...
        val expectedMessage =
            testContext.getString(mozilla.components.feature.addons.R.string.mozac_feature_addons_extension_failed_to_install)
    ...
    fun `WHEN calling handleInstallationFailedRequest with CorruptFile error THEN showDialog with the correct message`() {
        ...
        val expectedMessage =
            testContext.getString(mozilla.components.feature.addons.R.string.mozac_feature_addons_extension_failed_to_install_corrupt_error)
    ...
    fun `WHEN calling handleInstallationFailedRequest with NotSigned error THEN showDialog with the correct message`() {
        ...
        val expectedMessage =
            testContext.getString(mozilla.components.feature.addons.R.string.mozac_feature_addons_extension_failed_to_install_not_signed_error)
    ...
    fun `GIVEN Optional Permissions WHEN handleAfterInstallationRequest is called THEN handleOptionalPermissionsRequest is called`() {
        webExtensionPromptFeature.start()
        val request =
            mockk<WebExtensionPromptRequest.AfterInstallation.Permissions.Optional>(relaxed = true)
    ...
    fun `WHEN calling handleInstallationFailedRequest with AdminInstallOnly error THEN showDialog with the correct message`() {
        ...
        val expectedMessage =
            testContext.getString(mozilla.components.feature.addons.R.string.mozac_feature_addons_admin_install_only, extensionName)
    ...
    fun `WHEN calling handleInstallationFailedRequest with SoftBlocked error THEN showDialog with the correct message`() {
        ...
        val expectedMessage =
            testContext.getString(
                mozilla.components.feature.addons.R.string.mozac_feature_addons_soft_blocked_1,
                extensionName,
                appName,
            )
        val expectedUrl =
