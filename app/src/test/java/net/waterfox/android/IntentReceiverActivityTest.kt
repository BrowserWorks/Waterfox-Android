...
import net.waterfox.android.components.IntentProcessors
...
import net.waterfox.android.shortcut.NewTabShortcutIntentProcessor
...
class IntentReceiverActivityTest {
    ...
    @After
    fun teardown() {
        unmockkStatic("net.waterfox.android.ext.ContextKt")
    }
