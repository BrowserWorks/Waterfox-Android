...
package net.waterfox.android.nimbus
...
//import net.waterfox.android.nimbus.controller.NimbusBranchesController
//import net.waterfox.android.utils.Settings

// TODO: [Waterfox] remove the whole file when removing Nimbus
...
//        }
//
//        mockkObject(WaterfoxSnackbar)
//        every { WaterfoxSnackbar.make(any(), any(), any(), any()) } returns snackbar
//
//        every { activity.settings() } returns settings
//
//        every { navController.currentDestination } returns mockk {
//            every { id } returns net.waterfox.android.R.id.nimbusBranchesFragment
//        }
//
