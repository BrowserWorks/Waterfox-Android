...
class DownloadItemKtTest {
    ...
    fun getIcon() {
        ...
        assertEquals(R.drawable.ic_file_type_apk, downloadItem.copy(contentType = null, fileName = "Waterfox.apk").getIcon())
        assertEquals(R.drawable.ic_file_type_zip, downloadItem.copy(contentType = null, fileName = "Waterfox.zip").getIcon())
        assertEquals(R.drawable.ic_file_type_document, downloadItem.copy(contentType = null, fileName = "Waterfox.pdf").getIcon())
