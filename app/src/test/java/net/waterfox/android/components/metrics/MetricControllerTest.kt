...
package net.waterfox.android.components.metrics
...
import net.waterfox.android.GleanMetrics.BrowserSearch
import net.waterfox.android.GleanMetrics.ContextualMenu
import net.waterfox.android.GleanMetrics.CreditCards
import net.waterfox.android.GleanMetrics.LoginDialog
import net.waterfox.android.GleanMetrics.MediaNotification
import net.waterfox.android.GleanMetrics.PerfAwesomebar
import net.waterfox.android.GleanMetrics.ProgressiveWebApp
import net.waterfox.android.GleanMetrics.SitePermissions
import net.waterfox.android.GleanMetrics.SyncedTabs
import net.waterfox.android.components.metrics.ReleaseMetricController.Companion
import net.waterfox.android.helpers.WaterfoxRobolectricTestRunner
import net.waterfox.android.search.awesomebar.ShortcutsSuggestionProvider
