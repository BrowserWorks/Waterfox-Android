...
fun TertiaryButton(
    ...
    Button(
        text = text,
        textColor = WaterfoxTheme.colors.textActionTertiary,
        backgroundColor = WaterfoxTheme.colors.actionTertiary,
        icon = icon,
        tint = WaterfoxTheme.colors.iconActionTertiary,
        onClick = onClick,
    )
}
...
fun DestructiveButton(
    ...
    Button(
        text = text,
        textColor = WaterfoxTheme.colors.textWarningButton,
        backgroundColor = WaterfoxTheme.colors.actionSecondary,
        icon = icon,
        tint = WaterfoxTheme.colors.iconWarningButton,
        onClick = onClick,
    )
}
