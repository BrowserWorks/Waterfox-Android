...
import net.waterfox.android.GleanMetrics.Activation
import net.waterfox.android.GleanMetrics.Pings
import net.waterfox.android.components.metrics.MetricsUtils.getHashedIdentifier
...
class ActivationPing(private val context: Context) {
     ...
     *
     * Note that this only tells us that Waterfox triggered the
     ...
     * Then, mark it so that it doesn't get triggered next time Waterfox
     * starts.
     */
    fun checkAndSend() {
