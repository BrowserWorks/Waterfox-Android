...
import net.waterfox.android.customtabs.FennecWebAppIntentProcessor
import net.waterfox.android.home.intent.FennecBookmarkShortcutsIntentProcessor
import net.waterfox.android.intent.ExternalDeepLinkIntentProcessor
