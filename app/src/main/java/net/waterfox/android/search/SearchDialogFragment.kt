...
import net.waterfox.android.databinding.FragmentSearchDialogBinding
import net.waterfox.android.databinding.SearchSuggestionsHintBinding
import net.waterfox.android.ext.components
import net.waterfox.android.ext.increaseTapArea
import net.waterfox.android.ext.requireComponents
import net.waterfox.android.ext.settings
import net.waterfox.android.search.awesomebar.AwesomeBarView
import net.waterfox.android.search.awesomebar.toSearchProviderState
import net.waterfox.android.search.toolbar.IncreasedTapAreaActionDecorator
import net.waterfox.android.search.toolbar.SearchSelectorMenu
import net.waterfox.android.search.toolbar.SearchSelectorToolbarAction
import net.waterfox.android.search.toolbar.ToolbarView
import net.waterfox.android.settings.SupportUtils
import net.waterfox.android.widget.VoiceSearchActivity
