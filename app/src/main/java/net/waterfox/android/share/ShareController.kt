...
class DefaultShareController(
    ...
    private val snackbar: WaterfoxSnackbar,
        ...
        val result = try {
            ...
            when (e) {
                is SecurityException, is ActivityNotFoundException -> {
                    ...
                    snackbar.setLength(WaterfoxSnackbar.LENGTH_LONG)
                    snackbar.show()
    ...
    private fun copyClipboard() {
        ...
        snackbar.setLength(WaterfoxSnackbar.LENGTH_SHORT)
        snackbar.show()
    }

    companion object {
        const val ACTION_COPY_LINK_TO_CLIPBOARD = "net.waterfox.android.COPY_LINK_TO_CLIPBOARD"
    }
}
