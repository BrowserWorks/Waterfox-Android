...
import net.waterfox.android.ext.getStringWithArgSafe
...
class CustomTabToolbarMenu(
    ...
    private val openInWaterfox = SimpleBrowserMenuItem(
        label = context.getString(R.string.browser_menu_open_in_waterfox, appName),
        textColorResource = primaryTextColor()
    ) {
        onItemTapped.invoke(ToolbarMenu.Item.OpenInWaterfox)
    }
