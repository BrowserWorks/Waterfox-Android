...
class WaterfoxOnboarding(context: Context) : PreferencesHolder {
    ...
    companion object {
         ...
         */
        private const val PREF_NAME_ONBOARDING_KEY = "waterfox.onboarding"

        /**
         * Key for [onboardedVersion].
         */
        @VisibleForTesting
        internal const val LAST_VERSION_ONBOARDING_KEY = "waterfox.onboarding.last_version"
    }
}
