...
class Settings(private val appContext: Context) : PreferencesHolder {
    ...
    companion object {
        const val WATERFOX_PREFERENCES = "waterfox_preferences"
    ...
    override val preferences: SharedPreferences =
        appContext.getSharedPreferences(WATERFOX_PREFERENCES, MODE_PRIVATE)
    ...
    /**
     * Indicates if the Waterfox logo on the home screen should be animated,
     * to show users that they can change the wallpaper by tapping on the Waterfox logo.
     */
