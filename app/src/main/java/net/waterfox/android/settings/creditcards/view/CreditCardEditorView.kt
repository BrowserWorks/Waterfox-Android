...
import net.waterfox.android.databinding.FragmentCreditCardEditorBinding
import net.waterfox.android.ext.toEditable
import net.waterfox.android.settings.creditcards.CreditCardEditorFragment
import net.waterfox.android.settings.creditcards.CreditCardEditorState
import net.waterfox.android.settings.creditcards.interactor.CreditCardEditorInteractor
import net.waterfox.android.settings.creditcards.last4Digits
import net.waterfox.android.settings.creditcards.toCreditCardNumber
import net.waterfox.android.settings.creditcards.validateCreditCardNumber
