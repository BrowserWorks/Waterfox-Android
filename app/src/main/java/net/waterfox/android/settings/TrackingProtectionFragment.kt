...
import net.waterfox.android.trackingprotection.TrackingProtectionMode
 ...
 * to open info about the tracking protection [net.waterfox.android.settings.TrackingProtectionFragment].
 */
