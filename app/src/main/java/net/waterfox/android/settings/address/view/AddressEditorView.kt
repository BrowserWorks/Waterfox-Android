...
package net.waterfox.android.settings.address.view
...
import net.waterfox.android.settings.address.AddressEditorFragment
import net.waterfox.android.settings.address.AddressUtils.countries
import net.waterfox.android.settings.address.Country
import net.waterfox.android.settings.address.DEFAULT_COUNTRY
import net.waterfox.android.settings.address.interactor.AddressEditorInteractor
import net.waterfox.android.settings.address.toCountryCode
