...
import net.waterfox.android.settings.logins.interactor.LoginDetailInteractor
import net.waterfox.android.settings.logins.togglePasswordReveal
import net.waterfox.android.settings.logins.view.LoginDetailsBindingDelegate
