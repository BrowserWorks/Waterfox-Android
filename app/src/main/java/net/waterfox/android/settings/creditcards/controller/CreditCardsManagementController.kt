...
package net.waterfox.android.settings.creditcards.controller

import androidx.navigation.NavController
import mozilla.components.concept.storage.CreditCard
import net.waterfox.android.settings.creditcards.CreditCardsManagementFragment
import net.waterfox.android.settings.creditcards.CreditCardsManagementFragmentDirections
