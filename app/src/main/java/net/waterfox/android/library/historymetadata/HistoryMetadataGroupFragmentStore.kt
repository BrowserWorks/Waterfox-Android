...
sealed class HistoryMetadataGroupFragmentAction : Action {
    ...
    /**
     * Updates the set of items marked for removal from the [net.waterfox.android.components.AppStore]
    ...
    /**
     * Updates the empty state of [net.waterfox.android.library.historymetadata.view.HistoryMetadataGroupView].
     */
