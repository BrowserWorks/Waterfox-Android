...
object Performance {
     ...
     * tries to leverage this intent to trigger a code path for Waterfox that shouldn't be used unless
     * it is for testing visual metrics. These checks aren't full proof but most of our users won't have
     * ADB on and charging at the same time when running Waterfox.
     */
    ...
    private fun disableOnboarding(context: Context) {
        WaterfoxOnboarding(context).finish()
    }
