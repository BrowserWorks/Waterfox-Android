...
private val waterfox_features = arrayOf(
    "screenshots", "js", "leaf", "stackwalk", "cpu", "java",
    "processcpu", "ipcmessages", "java"
)
private val waterfox_threads = arrayOf(
...
enum class ProfilerSettings(val threads: Array<String>, val features: Array<String>) {
    Waterfox(waterfox_threads, waterfox_features),
...
object ProfilerUtils {
    ...
    /**
     * This will either save the profile locally or send it as a URL to the Waterfox profiler server
     *
