...
import net.waterfox.android.ext.getAndIncrementNoOverflow
...
/**
 * Counts the number of inflations Waterfox does. This class behaves only as an inflation counter since
