...
/**
 * The theme for Waterfox for Android.
 *
...
object WaterfoxTheme {
    val colors: WaterfoxColors
        @Composable
        get() = localWaterfoxColors.current

    val typography: WaterfoxTypography
        get() = defaultTypography
}

private val privateColorPalette = WaterfoxColors(
...
/**
 * A custom Color Palette for Waterfox for Android.
 */
@Suppress("LargeClass", "LongParameterList")
@Stable
class WaterfoxColors(
    layer1: Color,
    layer2: Color,
    layer3: Color,
    layer4Start: Color,
    ...
    fun update(other: WaterfoxColors) {
        layer1 = other.layer1
        layer2 = other.layer2
        layer3 = other.layer3
    ...
    fun copy(): WaterfoxColors = WaterfoxColors(
        layer1 = layer1,
        layer2 = layer2,
        layer3 = layer3,
...
fun ProvideWaterfoxColors(
    ...
    CompositionLocalProvider(localWaterfoxColors provides colorPalette, content = content)
}

private val localWaterfoxColors = staticCompositionLocalOf<WaterfoxColors> {
    error("No WaterfoxColors provided")
}
