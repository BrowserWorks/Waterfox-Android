...
import net.waterfox.android.home.recentsyncedtabs.controller.DefaultRecentSyncedTabController
import net.waterfox.android.home.recenttabs.RecentTabsListFeature
import net.waterfox.android.home.recenttabs.controller.DefaultRecentTabsController
import net.waterfox.android.home.recentvisits.RecentVisitsFeature
import net.waterfox.android.home.recentvisits.controller.DefaultRecentVisitsController
...
class HomeFragment : Fragment() {
    ...
    private val onboarding by lazy {
        requireComponents.strictMode.resetAfter(StrictMode.allowThreadDiskReads()) {
            WaterfoxOnboarding(requireContext())
        }
    }
                        ...
                        if (authType != AuthType.Existing) {
                            view?.let {
                                WaterfoxSnackbar.make(
                                    ...
                                    .setText(it.context.getString(R.string.onboarding_waterfox_account_sync_is_on))
    ...
    // TODO use [WaterfoxTabCounterToolbarButton] instead of [TabCounter]:
    ...
    private fun shouldAnimateLogoForWallpaper(): Boolean {
        ...
        return shouldEnableWallpaper() && settings.shouldAnimateWaterfoxLogo &&
            onboarding.userHasBeenOnboarded() &&
