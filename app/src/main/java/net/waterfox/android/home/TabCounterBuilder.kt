...
import net.waterfox.android.components.toolbar.WaterfoxTabCounterMenu
import net.waterfox.android.ext.nav

/**
 * Helper class for building the [WaterfoxTabCounterMenu].
 *
...
class TabCounterBuilder(
    ...
    /**
     * Builds the [WaterfoxTabCounterMenu].
     */
    fun build() {
        val tabCounterMenu = WaterfoxTabCounterMenu(
            context = context,
