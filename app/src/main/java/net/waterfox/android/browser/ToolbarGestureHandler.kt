...
import net.waterfox.android.ext.getRectWithScreenLocation
import net.waterfox.android.ext.getWindowInsets
import net.waterfox.android.ext.isKeyboardVisible
