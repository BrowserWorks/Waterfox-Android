...
import net.waterfox.android.components.WaterfoxSnackbar.Companion.LENGTH_ACCESSIBLE
...
class WaterfoxSnackbarDelegate(private val view: View) : SnackbarDelegate {
    ...
    private var snackbar: WaterfoxSnackbar? = null
    ...
    override fun show(
        ...
        if (duration == WaterfoxSnackbar.LENGTH_INDEFINITE) {
