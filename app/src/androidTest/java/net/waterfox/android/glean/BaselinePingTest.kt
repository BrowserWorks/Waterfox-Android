...
package net.waterfox.android.glean
...
import net.waterfox.android.helpers.MockWebServerHelper
...
class BaselinePingTest {
    ...
    companion object {
        ...
        fun setupOnce() {
            ...
            // F e n i x  does not initialize the Glean SDK in tests/debug builds, but this test
