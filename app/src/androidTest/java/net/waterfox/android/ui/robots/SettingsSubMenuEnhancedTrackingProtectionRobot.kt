...
import net.waterfox.android.helpers.assertIsChecked
import net.waterfox.android.helpers.click
import net.waterfox.android.helpers.isChecked
import net.waterfox.android.helpers.isEnabled
...
private fun assertNavigationToolBarHeader() {
    onView(
        allOf(
            withParent(withId(net.waterfox.android.R.id.navigationToolbar)),
...
private fun assertEnhancedTrackingProtectionOptionsState(enabled: Boolean) {
    ...
    onView(withText(net.waterfox.android.R.string.preference_enhanced_tracking_protection_standard_description_4))
        .check(matches(isEnabled(enabled)))

    onView(withText("Strict"))
        .check(matches(isEnabled(enabled)))

    onView(withText(net.waterfox.android.R.string.preference_enhanced_tracking_protection_strict_description_3))
        .check(matches(isEnabled(enabled)))

    onView(withText("Custom"))
        .check(matches(isEnabled(enabled)))

    onView(withText(net.waterfox.android.R.string.preference_enhanced_tracking_protection_custom_description_2))
        .check(matches(isEnabled(enabled)))
}
...
private fun assertRadioButtonDefaults() {
    ...
    onView(
        allOf(
            withId(net.waterfox.android.R.id.radio_button),
