...
import net.waterfox.android.ui.robots.settingsScreen
...
class SettingsPrivacyTest {
    ...
    fun verifyMultipleLoginsSelectionsTest() {
        ...
        navigationToolbar {
            ...
            fillAndSubmitLoginCredentials("waterfoxco", "waterfox")
            saveLoginFromPrompt("Save")
            fillAndSubmitLoginCredentials("waterfox", "waterfoxco")
            saveLoginFromPrompt("Save")
            clearUserNameLoginCredential()
            clickSuggestedLoginsButton()
            verifySuggestedUserName("waterfox")
            verifySuggestedUserName("waterfoxco")
            clickLoginSuggestion("waterfoxco")
            verifyPrefilledLoginCredentials("waterfoxco")
        }
    }
    ...
    fun saveLoginsInPWATest() {
        ...
        navigationToolbar {
            ...
            browserScreen {
                ...
                verifySecurityPromptForLogins()
                tapSetupLater()
                verifySavedLoginFromPrompt("waterfoxco")
            }

            addToHomeScreen {
            }.searchAndOpenHomeScreenShortcut(shortcutTitle) {
                verifyPrefilledPWALoginCredentials("waterfoxco", shortcutTitle)
            }
        }
    }
}
