...
import net.waterfox.android.helpers.TestHelper.hasCousin
...
import net.waterfox.android.ui.robots.SettingsRobot.Companion.DEFAULT_APPS_SETTINGS_ACTION
...
class SettingsRobot {
    ...
    class Transition {
        ...
        fun openAboutWaterfoxPreview(interact: SettingsSubMenuAboutRobot.() -> Unit):
            SettingsSubMenuAboutRobot.Transition {

            aboutWaterfoxHeading().click()
